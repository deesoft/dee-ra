...
return[
    ...
    ['label' => 'Laporan', 'icon' => 'pie-chart', 'iconOptions' => ['class' => 'text-aqua'],
        'url' => ['/report/report/index']],
    ['label' => 'Master Data', 'icon' => 'th', 'visible' => true,
        'items' => [
    ...
    ['label' => 'Penjualan', 'icon' => 'shopping-cart', 'iconOptions' => ['class' => 'text-orange'],
        'items' => [
    ...
    ['label' => 'Pengelolaan Persedian', 'icon' => 'truck', 'iconOptions' => ['class' => 'text-success'],
        'items' => [
    ...
    ['label' => 'Akunt Keuangan', 'icon' => 'buysellads',
        'items' => [
