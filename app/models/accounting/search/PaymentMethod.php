...
use app\models\accounting\PaymentMethod as PaymentMethodModel;

/**
 * PaymentMethod represents the model behind the search form about `app\models\accounting\PaymentMethod`.
 */
