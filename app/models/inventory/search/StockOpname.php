...
use app\models\inventory\StockOpname as StockOpnameModel;

/**
 * StockOpname represents the model behind the search form about `app\models\inventory\StockOpname`.
 */
