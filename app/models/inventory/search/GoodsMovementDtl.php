...
use app\models\inventory\GoodsMovementDtl as GoodsMovementDtlModel;

/**
 * GoodsMovementDtl represents the model behind the search form about `app\models\inventory\GoodsMovementDtl`.
 */
