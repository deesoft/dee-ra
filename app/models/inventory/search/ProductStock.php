...
use app\models\inventory\ProductStock as ProductStockModel;

/**
 * ProductStock represents the model behind the search form about `app\models\inventory\ProductStock`.
 */
